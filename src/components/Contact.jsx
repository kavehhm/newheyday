      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:py-48 lg:px-8">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 overflow-hidden ring-1 ring-white/5 w-full">
              <svg
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Instant replies if you send a text, a bit slower if you send an email :)
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-white" href="tel:9492919229">
                    +1 (949) 291-9229
                  </a>
                </dd>
              </div>
